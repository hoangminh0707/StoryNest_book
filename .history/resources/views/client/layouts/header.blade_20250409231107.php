    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
          ...
          <li class="nav-item">
            <a class="nav-link me-4" href="{{ route('blog') }}">Blogs</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Pages</a>
            <ul class="dropdown-menu animate slide border">
              <li><a href="{{ route('about') }}" class="dropdown-item fw-light">About <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('shop') }}" class="dropdown-item fw-light">Shop <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('product') }}" class="dropdown-item fw-light">Single Product <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('cart') }}" class="dropdown-item fw-light">Cart <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('checkout') }}" class="dropdown-item fw-light">Checkout <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('blog') }}" class="dropdown-item fw-light">Blog <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('post') }}" class="dropdown-item fw-light">Single Post <span class="badge bg-primary">Pro</span></a></li>
              <li><a href="{{ route('contact') }}" class="dropdown-item fw-light">Contact <span class="badge bg-primary">Pro</span></a></li>
            </ul>
          </li>
          <li class="nav-item">
        ...
        <div class="user-items d-flex">
          <ul class="d-flex justify-content-end list-unstyled mb-0">
            ...
            <li class="wishlist-dropdown dropdown pe-3">
              ...
              <!-- wishlist dropdown content here -->
            </li>
            <li class="cart-dropdown dropdown">
              <a href="{{ route('cart') }}" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
              ...
              <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                <div class="d-flex flex-wrap justify-content-center">
                  <a href="{{ route('cart') }}" class="w-100 btn btn-dark mb-1">View Cart</a>
                  <a href="{{ route('checkout') }}" class="w-100 btn btn-primary">Go to checkout</a>
                </div>
              </div>
            </li>
          </ul>
