<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <div class="top-info border-bottom d-none d-md-block">
    <div class="container-fluid">
      <div class="row g-0">
        <div class="col-md-4">
          <p class="fs-6 my-2 text-center">Cần hỗ trợ? Gọi ngay <a href="#">112233344455</a></p>
        </div>
        <div class="col-md-4 border-start border-end">
          <p class="fs-6 my-2 text-center">Ưu đãi mùa hè giảm đến 60%! <a class="text-decoration-underline" href="shop.html">Mua ngay</a></p>
        </div>
        <div class="col-md-4">
          <p class="fs-6 my-2 text-center">Giao hàng 2-3 ngày làm việc &amp; miễn phí đổi trả</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
        <div class="offcanvas-header px-4 pb-0">
          ...
          <button type="button" class="btn-close btn-close-black" data-bs-dismiss="offcanvas" aria-label="Đóng" data-bs-target="#bdNavbar"></button>
        </div>
        <div class="offcanvas-body">
          <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Trang khác</a>
              <ul class="dropdown-menu animate slide border">
                <li><a href="http://storynest_book.test/about" class="dropdown-item fw-light">Giới thiệu <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/shop" class="dropdown-item fw-light">Cửa hàng <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/product" class="dropdown-item fw-light">Chi tiết sản phẩm <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/cart" class="dropdown-item fw-light">Giỏ hàng <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/checkout" class="dropdown-item fw-light">Thanh toán <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/blog" class="dropdown-item fw-light">Bài viết <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/post" class="dropdown-item fw-light">Bài viết chi tiết <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="http://storynest_book.test/contact" class="dropdown-item fw-light">Liên hệ <span class="badge bg-primary">Pro</span></a></li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <ul class="d-flex justify-content-end list-unstyled mb-0">
                          ...
                          <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel" aria-labelledby="nav-sign-in-tab">
                              <div class="form-group py-3">
                                <label class="mb-2">Tên đăng nhập hoặc email *</label>
                                <input type="text" name="username" placeholder="Nhập tên đăng nhập" class="form-control w-100 rounded-3 p-3" required>
                              </div>
                              <div class="form-group pb-3">
                                <label class="mb-2">Mật khẩu *</label>
                                <input type="password" name="password" placeholder="Nhập mật khẩu" class="form-control w-100 rounded-3 p-3" required>
                              </div>
                              <label class="py-3">
                            ...
                            <div class="tab-pane fade" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
                              <div class="form-group py-3">
                                ...
                                <input type="text" name="username" placeholder="Nhập email" class="form-control w-100 rounded-3 p-3" required>
                              </div>
                              <div class="form-group pb-3">
                                <label class="mb-2">Mật khẩu *</label>
                                <input type="password" name="password" placeholder="Nhập mật khẩu" class="form-control w-100 rounded-3 p-3" required>
                ...
                <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                  ...
                  <ul class="list-group mb-3">
                    <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                      <div>
                        <h5><a href="single-product.html">Vương miện ngọc lục</a></h5>
                    ...
                    <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                      <div>
                        <h5><a href="single-product.html">Phép thuật cuối cùng</a></h5>
                        <small>Phù hợp với những người khai sáng.</small>
                        <a href="#" class="d-block fw-medium text-capitalize mt-2">Thêm vào giỏ</a>
                      </div>
                      <span class="text-primary">$400</span>
                    </li>
                    <li class="list-group-item bg-transparent d-flex justify-content-between">
                      <span class="text-capitalize"><b>Tổng cộng (USD)</b></span>
                      <strong>$2400</strong>
                    </li>
                  </ul>
                  <div class="d-flex flex-wrap justify-content-center">
                    <a href="#" class="w-100 btn btn-dark mb-1">Thêm tất cả vào giỏ</a>
                    <a href="cart.html" class="w-100 btn btn-primary">Xem giỏ hàng</a>
                  </div>
                </div>
              </li>
              ...
              <li class="cart-dropdown dropdown">
                <a href="cart.html" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                  <svg class="cart"><use xlink:href="#cart"></use></svg><span class="fs-6 fw-light">(02)</span>
                </a>
                <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                  <h4 class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <ul class="list-group mb-3">
                    <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                      <div>
                        <h5><a href="single-product.html">Bí mật của nhà giả kim</a></h5>
                    ...
                    <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                      <div>
                        <h5><a href="single-product.html">Cuộc truy tìm thành phố mất tích</a></h5>
                        <small>Cuộc phiêu lưu đầy chuyên nghiệp.</small>
                      </div>
                  ...
                  <div class="d-flex flex-wrap justify-content-center">
                    <a href="http://storynest_book.test/cart" class="w-100 btn btn-dark mb-1">Xem giỏ hàng</a>
                    <a href="http://storynest_book.test/checkout" class="w-100 btn btn-primary">Tiến hành thanh toán</a>
                  </div>
                </div>
              </li>
            </ul>
