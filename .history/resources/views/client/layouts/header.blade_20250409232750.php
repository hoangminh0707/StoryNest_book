          ...
          <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu animate slide border">
                ...
                <li>
                <a href="{{ route('product') }}" class="dropdown-item fw-light">Single Product <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('cart') }}" class="dropdown-item fw-light">Cart <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('checkout') }}" class="dropdown-item fw-light">Checkout <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('blog') }}" class="dropdown-item fw-light">Blog <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
            ...
            <ul class="d-flex justify-content-end list-unstyled mb-0">
              ...
              <li class="cart-dropdown dropdown">
                ...
                <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                  ...
                  <div class="d-flex flex-wrap justify-content-center">
                  <a href="{{ route('cart') }}" class="w-100 btn btn-primary" type="submit">View cart</a> 
