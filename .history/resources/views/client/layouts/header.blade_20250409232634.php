    ...
    <div class="container-fluid">
      <div class="row g-0">
        ...
        <div class="col-md-4 border-start border-end">
          <p class="fs-6 my-2 text-center">Summer sale discount off 60% off!
            <a class="text-decoration-underline" href="{{ route('shop') }}">Shop Now</a> <!-- CHANGED -->
          </p>
        </div>
        <div class="col-md-4">
          ...
          <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu animate slide border">
                <li>
                <a href="{{ route('about') }}" class="dropdown-item fw-light">About <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                ...
                <li>
                <a href="{{ route('checkout') }}" class="dropdown-item fw-light">Checkout <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('blog.index') }}" class="dropdown-item fw-light">Blog <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('blog.show', ['id' => 1]) }}" class="dropdown-item fw-light">Single Post <span class="badge bg-primary">Pro</span></a>
                </li>
                <li>
                <a href="{{ route('contact') }}" class="dropdown-item fw-light">Contact <span class="badge bg-primary">Pro</span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <ul class="d-flex justify-content-end list-unstyled mb-0">
              ...
              <li class="cart-dropdown dropdown">
                ...
                <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                  ...
                  <div class="d-flex flex-wrap justify-content-center">
                  <a href="{{ route('cart.index') }}" class="w-100 btn btn-primary" type="submit">View cart</a> <!-- cart.html -> route -->
