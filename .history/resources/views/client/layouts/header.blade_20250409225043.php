        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
              <li class="nav-item">
                <a class="nav-link me-4 active" href="{{ route('pages.index') }}">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4" href="{{ route('pages.index') }}/about">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4" href="{{ route('pages.index') }}/shop">Shop</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4" href="{{ route('pages.index') }}/blog">Blogs</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Pages</a>
                <ul class="dropdown-menu animate slide border">
                  <li>
                    <a href="{{ route('pages.index') }}/about" class="dropdown-item fw-light">About <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/shop" class="dropdown-item fw-light">Shop <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/product" class="dropdown-item fw-light">Single Product <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/cart" class="dropdown-item fw-light">Cart <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/checkout" class="dropdown-item fw-light">Checkout <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/blog" class="dropdown-item fw-light">Blog <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/post" class="dropdown-item fw-light">Single Post <span class="badge bg-primary">Pro</span></a>
                  </li>
                  <li>
                    <a href="{{ route('pages.index') }}/contact" class="dropdown-item fw-light">Contact <span class="badge bg-primary">Pro</span></a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4" href="{{ route('pages.index') }}/contact">Contact</a>
              </li>
              <li class="nav-item">
              </li>
            </ul>
              ...
              <ul class="d-flex justify-content-end list-unstyled mb-0">
                ...
                <li class="cart-dropdown dropdown">
                  ...
                  <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                    ...
                    <div class="d-flex flex-wrap justify-content-center">
                      <a href="{{ route('pages.index') }}/cart" class="w-100 btn btn-dark mb-1" type="submit">View Cart</a>
                      <a href="{{ route('pages.index') }}/checkout" class="w-100 btn btn-primary" type="submit">Go to checkout</a>
                    </div>
                  </div>
                </li>
              </ul>
