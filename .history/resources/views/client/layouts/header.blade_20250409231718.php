  ...
  <nav class="navbar navbar-expand-lg py-3">
    <div class="container">
      <a class="navbar-brand" href="{{ route('home') }}">
        <img src="{{ asset('frontend/assets/images/logo-dark.svg') }}" alt="Logo" />
      </a>
      <button class="navbar-toggler p-0 border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNav"
        aria-controls="offcanvasNav">
        <i class="ri-menu-3-line"></i>
      </button>

      <div class="offcanvas offcanvas-start-lg" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel">
        ...
        <div class="offcanvas-body p-lg-0">
          <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
            ...
            <li class="nav-item">
              <a class="nav-link me-4" href="{{ route('about') }}">Giới thiệu</a>
            </li>
            <li class="nav-item">
              <a class="nav-link me-4" href="{{ route('shop') }}">Cửa hàng</a>
            </li>
            <li class="nav-item">
              <a class="nav-link me-4" href="{{ route('blog') }}">Bài viết</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu animate slide border">
                <li><a href="{{ route('about') }}" class="dropdown-item fw-light">Giới thiệu <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('shop') }}" class="dropdown-item fw-light">Cửa hàng <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('product') }}" class="dropdown-item fw-light">Chi tiết sản phẩm <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('cart') }}" class="dropdown-item fw-light">Giỏ hàng <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('checkout') }}" class="dropdown-item fw-light">Thanh toán <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('blog') }}" class="dropdown-item fw-light">Bài viết <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('post') }}" class="dropdown-item fw-light">Chi tiết bài viết <span class="badge bg-primary">Pro</span></a></li>
                <li><a href="{{ route('contact') }}" class="dropdown-item fw-light">Liên hệ <span class="badge bg-primary">Pro</span></a></li>
              </ul>
            </li>
            <li class="nav-item">
      ...
      <ul class="d-flex list-unstyled gap-3 align-items-center mb-0">
        <li>
          <a href="#" class="text-decoration-none text-dark fs-5" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch">
            <i class="ri-search-line"></i>
          </a>
        </li>
        <li>
          <a href="#" class="text-decoration-none text-dark fs-5 position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-body">
      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex align-items-start border-top px-0 pb-4 pt-0">
          <div class="me-3">
            <img src="{{ asset('frontend/assets/images/products/pr-1.jpg') }}" alt="Sản phẩm" width="80" class="img-fluid rounded" />
          </div>
          <div class="flex-grow-1">
            <h6 class="mb-1">Tên sản phẩm</h6>
            <div class="d-flex align-items-center justify-content-between">
              <span class="small">1 x 100.000đ</span>
              <a href="#" class="text-muted small text-decoration-none">Xóa</a>
            </div>
          </div>
        </li>
      </ul>
      <div class="d-flex justify-content-between border-top py-3 mb-3">
        <span class="fw-bold">Tổng cộng:</span>
        <span class="fw-bold">100.000đ</span>
      </div>
      <a href="{{ route('cart') }}" class="w-100 btn btn-dark mb-1">Xem giỏ hàng</a>
      <a href="{{ route('checkout') }}" class="w-100 btn btn-primary">Tiến hành thanh toán</a>
    </div>
  </div>
</header>
