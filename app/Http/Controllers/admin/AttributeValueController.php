...
class AttributeValueController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.attributes.index', compact('attributeValues', 'attributes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.attribute-values.index')->with('success', 'Thêm giá trị thuộc tính thành công.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.attribute-values.index')->with('success', 'Cập nhật thành công.');
    }
