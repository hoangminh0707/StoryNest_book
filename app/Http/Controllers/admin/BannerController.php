...
class BannerController extends Controller
{
    ...
    public function toggleStatus($id)
    {
        ...
        return redirect()->route('banners.index')->with('success', 'Cập nhật trạng thái thành công!');
    }
    ...
    //     return redirect()->route('banners.index')->with('success', 'Xóa các banner đã chọn thành công!');
    // }
