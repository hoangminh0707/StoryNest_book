...
class ShippingMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('shipping-methods.index')->with('success', 'Thêm phương thức vận chuyển thành công!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('shipping-methods.index')->with('success', 'Cập nhật phương thức vận chuyển thành công!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('shipping-methods.index')->with('success', 'Xóa phương thức vận chuyển thành công!');
    }
    ...
    public function toggleStatus($id)
    {
        ...
        return redirect()->route('shipping-methods.index')->with('success', 'Cập nhật trạng thái thành công!');
    }
}
