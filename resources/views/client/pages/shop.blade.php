  ...
  <div class="shopify-grid padding-large">
    ...
    <div class="row flex-row-reverse g-md-5">
      ...
      <div class="filter-shop d-flex flex-wrap justify-content-between mb-5">
        ...
        <p>Hiển thị từ {{ $products->firstItem() }}–{{ $products->lastItem() }} trong tổng {{ $products->total() }}
          sản phẩm</p>
        </div>
  ...
  @endif
      ...
      <div class="sidebar ps-lg-5">
        ...
        <div class="widget-search-bar">
          ...
          <input class="form-control border-0 me-2 py-2" type="text" id="search" placeholder="Search"
