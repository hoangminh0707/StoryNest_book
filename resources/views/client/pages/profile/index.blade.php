...
<div class="container py-4">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <img src="{{ $user->avatar ? Storage::url($user->avatar) : 'https://i.ibb.co/R4Hqy0Lm/download.jpg' }}" alt="Avatar" class="rounded-circle mb-3" width="100" height="100">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="{{ route('profile.password.form') }}">Đổi mật khẩu</a></li>
                ...
                <li class="list-group-item">
                    <a href="{{ route('profile.email.change.form') }}">Đổi Email</a></li>
                @endif
            </ul>
        </div>
        ...
        <div class="col-md-9">
            ...
            <div class="card">
                <!-- Card header -->
                <div class="card-header bg-primary text-white">Cập nhật thông tin cá nhân</div>
                <div class="card-body">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if (is_null($user->email_verified_at))
                            <div class="text-danger mt-1">
                                <i class="bi bi-exclamation-circle-fill"></i> Vui lòng xác minh email để sử dụng đầy đủ chức năng. 
