...
>>>>>>> duong
                ...
                <div class="post-description review-item mt-4">
                  ...
                  <img src="assetClient/images/post-img.jpg" alt="post-image" class="img-fluid float-start me-3 col-md-5">
                      ...
                      <div class="comment-list padding-small">
                        <article class="comment-item d-flex flex-wrap mb-4">
                          <div class="col-lg-1 col-sm-3 me-4 mb-3">
                            <img src="assetClient/images/commentor-item1.jpg" alt="default" class="img-fluid rounded-3">
                          </div>
                        ...
                        <article class="comment-item d-flex child-comments flex-wrap ps-5 mb-4">
                          <div class="col-lg-1 col-sm-3 me-4 mb-3">
                            <img src="assetClient/images/commentor-item2.jpg" alt="default" class="img-fluid rounded-3">
                          </div>
                          <div class="col-lg-10 col-sm-9 author-wrap">
                            <div class="author-post">
                              <div class="comment-meta d-flex">
                        ...
                        <article class="comment-item d-flex flex-wrap">
                          <div class="col-lg-1 col-sm-3 me-4 mb-3">
                            <img src="assetClient/images/commentor-item3.jpg" alt="default" class="img-fluid rounded-3">
                          </div>
                          <div class="col-lg-10 col-sm-9 author-wrap">
                            <div class="author-post">
                              <div class="comment-meta d-flex">
                    ...
                    <div class="comment-respond mt-5">
                      ...
                      <form id="form" class="d-flex gap-3 flex-wrap">
                        <div class="w-100 d-flex gap-3">
                          ...
                          <div class="w-50">
                            <input type="text" name="email" placeholder="Viết email của bạn tại đây *" class="form-control w-100">
                          </div>
                        </div>
                        <div class="w-100">
                          <textarea placeholder="Viết bình luận của bạn ở đây *" class="form-control w-100"></textarea>
                        </div>
                        <label class="w-100">
