  ...
  <div class="choosing-area section-padding pt-0">
    ...
    <div class="row mbn-30">
      ...
      <div class="single-choose-item text-center mb-30">
        ...
        <p>StoryNet-Book cung cấp dịch vụ vận chuyển miễn phí cho tất cả các đơn hàng, giúp bạn dễ dàng sở hữu những
        cuốn sách yêu thích mà không lo về chi phí giao hàng.</p>
      </div>
      </div>
      <div class="col-lg-4 col-md-4">
      <div class="single-choose-item text-center mb-30">
        ...
        <p>StoryNet-Book cam kết giao sách nhanh chóng, giúp bạn nhanh chóng nhận được những cuốn sách yêu thích và
        tiếp cận tri thức mọi lúc, mọi nơi.</p>
      ...
      <div class="single-choose-item text-center mb-30">
        ...
        <p>StoryNet-Book luôn sẵn sàng hỗ trợ bạn trong suốt quá trình mua sắm, cam kết mang lại dịch vụ chăm sóc
        khách hàng tận tâm và nhanh chóng.</p>
      </div>
      </div>
    </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="testimonial-content-wrapper">
        ...
        <div class="testimonial-content">
          <p class="testimonial-text">"StoryNet-Book là một nơi tuyệt vời để tìm kiếm sách. Giao diện dễ sử dụng và
          dịch vụ giao hàng rất nhanh chóng!"</p>
          <div class="ratings">
        ...
        <div class="testimonial-content">
          <p class="testimonial-text">"Dịch vụ hỗ trợ khách hàng của StoryNet-Book thật tuyệt vời. Tôi luôn nhận
          được sự giúp đỡ kịp thời khi cần thiết."</p>
          <div class="ratings">
          <span><i class="fa fa-star-o"></i></span>
          <span><i class="fa fa-star-o"></i></span>
          <span><i class="fa fa-star-o"></i></span>
        ...
        <div class="testimonial-content">
          <p class="testimonial-text">"Tôi đã tìm thấy rất nhiều cuốn sách yêu thích tại StoryNet-Book. Chất lượng
          sách rất tốt và giá cả hợp lý."</p>
          <div class="ratings">
          <span><i class="fa fa-star-o"></i></span>
          <span><i class="fa fa-star-o"></i></span>
          <span><i class="fa fa-star-o"></i></span>
        ...
        <div class="testimonial-content">
          <p class="testimonial-text">"Thật tuyệt vời khi biết rằng tôi có thể đặt mua sách mọi lúc mọi nơi và được
          hỗ trợ 24/7!"</p>
          <div class="ratings">
          <span><i class="fa fa-star-o"></i></span>
          <span><i class="fa fa-star-o"></i></span>
  ...
  <div class="team-area section-padding">
    ...
    <div class="row mbn-30">
      ...
      <div class="team-member text-center">
        ...
        <div class="team-content">
        <h6 class="team-member-name">Hoàng Công Minh</h6>
      ...
      <div class="team-member text-center">
        ...
        <div class="team-content">
        <h6 class="team-member-name">Đinh Đức Dương</h6>
        <p>Điều hành</p>
        </div>
      </div>
      </div> <!-- end single team member -->
