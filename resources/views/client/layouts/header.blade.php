...
<header id="header" class="site-header">
  <div class="top-info border-bottom d-none d-md-block ">
    <div class="container-fluid">
      <div class="row g-0">
        <div class="col-md-4">
          <p class="fs-6 my-2 text-center">Cần hỗ trợ? Gọi cho chúng tôi <a href="#">112233344455</a></p>
        </div>
        <div class="col-md-4 border-start border-end">
          <p class="fs-6 my-2 text-center">Giảm giá mùa hè lên đến 60%! <a class="text-decoration-underline" href="{{ route('shop') }}">Mua ngay</a></p>
        </div>
        <div class="col-md-4">
          <p class="fs-6 my-2 text-center">Giao hàng trong 2-3 ngày &amp; đổi trả miễn phí</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="offcanvas-body">
          <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button">Trang</a>
              <ul class="dropdown-menu animate slide border">
                <li><a href="{{ route('about') }}" class="dropdown-item fw-light">Giới thiệu</a></li>
                <li><a href="{{ route('shop') }}" class="dropdown-item fw-light">Cửa hàng</a></li>
                <li><a href="{{ route('product') }}" class="dropdown-item fw-light">Sản phẩm</a></li>
                <li><a href="{{ route('cart') }}" class="dropdown-item fw-light">Giỏ hàng</a></li>
                <li><a href="{{ route('checkout') }}" class="dropdown-item fw-light">Thanh toán</a></li>
                <li><a href="{{ route('blog') }}" class="dropdown-item fw-light">Bài viết</a></li>
                <li><a href="{{ route('post') }}" class="dropdown-item fw-light">Bài viết chi tiết</a></li>
                <li><a href="{{ route('contact') }}" class="dropdown-item fw-light">Liên hệ</a></li>
              </ul>
            </li>
            <li class="nav-item">
