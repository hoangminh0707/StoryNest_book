<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="trash" viewBox="0 0 16 16">
    <path
      d="M5.5 5.5a.5.5 0 0 1 .5-.5h.5v6H6a.5.5 0 0 1-.5-.5v-5zM8 5h.5v6H8a.5.5 0 0 1-.5-.5v-5A.5.5 0 0 1 8 5zM10 5.5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-.5v-6h.5z" />
    <path fill-rule="evenodd"
      d="M14.5 3a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1H1v1a1 1 0 0 0 1 1h.5v9a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V5h.5a1 1 0 0 0 1-1V3h-.5zM4.118 5l.359 9h7.046l.359-9H4.118z" />
  </symbol>
  ...
  <nav id="header-nav" class="navbar navbar-expand-lg py-3">
    <div class="container">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
        ...
        <div class="offcanvas-body">
          <ul id="navbar"
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu animate slide border">
                ...
                <li>
                  <a href="{{ route('shop') }}" class="dropdown-item fw-light">Shop <span
          ...
          @endguest
            ...
            <hr class="my-1">
            <li><a class="dropdown-item" href="{{ route('profile.index') }}"> <i class="bi bi-gear-fill"></i> Cài
              đặt</a></li>
            <li><a class="dropdown-item" href="{{ route('orders.index') }}"> <i class="bi bi-box2"></i> Đơn
              Hàng</a></li>
            <li>
      ...
      <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
        ...
        @csrf
        <button type="submit" class="d-block fw-medium text-capitalize mt-2"
        style="all: unset; cursor: pointer;">Thêm vào giỏ hàng</button>
        </form>
        <a href="{{ route('wishlist.remove', $item->product->id) }}"
        class="d-block fw-medium text-capitalize mt-2">Xóa</a>
        </form>
        </div>
            ...
            @endphp
                      <li class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                        ...
                        <a href="#" onclick="event.preventDefault(); this.nextElementSibling.submit();"
                          class="text-danger mt-1" title="Xóa sản phẩm">
