                ...
                <div class="card-body">
                    <form action="{{ route('admin.shipping-methods.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="default_fee" class="form-control" value="{{ old('default_fee', 0) }}"
                                required min="0">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.shipping-methods.index') }}" class="btn btn-secondary me-2">Quay
                                lại</a>
