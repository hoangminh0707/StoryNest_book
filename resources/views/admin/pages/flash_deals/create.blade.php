...
@section('title', 'Tạo mới Flash Deal')
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white">
                <h5 class="card-title mb-0 text-primary fw-bold">Tạo Mới Flash Deal</h5>
            </div>
                ...
                <form action="{{ route('admin.flash_deals.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            value="{{ old('title') }}" placeholder="Nhập tiêu đề flash deal">
                        @error('title')
                 ...
                 <div class="mb-3">
                    ...
                    <input
                        type="text"  {{-- đổi type number thành text --}}
                        name="usage_limit"
                        id="usage_limit"
                    ...
                    <div class="mb-3">
                        ...
                        <div id="variant-container"
                            ...
                            @if(old('variant_ids') && count(old('variant_ids')) > 0)
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">Lưu Flash Deal</button>
                    </div>
                </form>
            ...
            fetch('{{ route("admin.flash_deals.getVariants") }}', {
                ...
                .then(data => {
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="variant_${variant.id}">
                         ${variant.name} - Giá gốc: <strong>${Number(variant.price).toLocaleString('vi-VN')} đ</strong>
                         </label>
                    </div>`;
                    });
