    ...
    <div class="col-lg-12">
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                ...
                // Cho phép thêm "cancelled" vào các trạng thái có thể hủy
                $validTransitions = [
                ...
                <form method="POST" action="{{ route('admin.orders.updateStatus', $order->id) }}" class="mt-3" onsubmit="return confirmCancel(this);">
                    @csrf
                    @method('PUT')
...
<script>
    function confirmCancel(form) {
        ...
        return true; // Cho phép submit nếu không phải hủy
    }
</script>
@endsection