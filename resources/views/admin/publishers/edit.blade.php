            ...
            <div class="card-body">
                <form action="{{ route('publishers.update', $publisher->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nationality" id="nationality" value="{{ old('nationality', $publisher->nationality) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="address" class="form-label">Địa Chỉ</label>
                        <textarea name="address" id="address" class="form-control" rows="3">{{ old('address', $publisher->address) }}</textarea>
                    </div>
