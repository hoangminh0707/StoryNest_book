            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle">
                        <img src="{{ asset('assets/images/flags/vn.svg') }}" alt="Header Language" height="20" class="rounded">
                    </button>
                </div>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUser" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUser">
                                <i class="ri-user-settings-line"></i> <span>User & Permision</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarUser">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.userIndex') }}" class="nav-link"> List User </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.roleIndex') }}" class="nav-link"> List roles </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">{{ View::getSection('title') ?? 'Admin Panel' }}</li>
                                    </ol>
                                </div>
                            </div>
