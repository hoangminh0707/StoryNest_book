            ...
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-1 topbar-head-dropdown header-item">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle">
                            <img src="http://127.0.0.1:8000/assets/images/flags/vn.svg" alt="Header Language"
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto dropdown-tabs">
                                            <span class="badge bg-light-subtle text-body fs-13" id="noti-count-label">0
                                                mới</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- SCRIPT TẢI THÔNG BÁO REAL-TIME -->
                    <script>
                        ...
                        function fetchNotifications() {
                            fetch('{{ route('admin.notifications.fetch') }}')
                                ...
                                .then(data => {
                                    ...
                                    // Phát âm thanh nếu có thêm thông báo mới
                    ...
                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <a href="${noti.url ?? '#'}" class="stretched-link">
                                    <h6 class="mt-0 mb-1 lh-base">${noti.title}</h6>
                                    <div class="text-muted fs-13">${noti.message}</div>
                                    <div class="text-muted fs-12 fst-italic">${noti.detail ?? ''}</div>
                                </a>
                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                    <span><i class="mdi mdi-clock-outline"></i> ${noti.time}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                <img class="rounded-circle header-profile-user"
                                    src="http://127.0.0.1:8000/assets/images/users/avatar-1.jpg" alt="Header Avatar">
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarUser">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ route('admin.userIndex') }}" class="nav-link"> Danh sách tài khoản
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('admin.shipping-methods.index') }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ View::getSection('title') ?? 'Admin Panel' }}</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                                <li class="breadcrumb-item active">
                                    {{ View::getSection('title') ?? 'Admin Panel' }}
                                </li>
                            </ol>
                        </div>
                    </div>
