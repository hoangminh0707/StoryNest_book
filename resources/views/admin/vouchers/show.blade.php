...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('vouchers.index') }}" class="btn btn-secondary btn-sm">← Quay lại</a>
        </div>
        <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><strong>Mã:</strong> <span class="text-primary fw-bold">{{ $voucher->code }}</span></li>
                <li class="list-group-item"><strong>Tên chương trình:</strong> {{ $voucher->name }}</li>
                <li class="list-group-item"><strong>Loại:</strong> {{ $voucher->type == 'percent' ? 'Phần trăm (%)' : 'Tiền mặt (VND)' }}</li>
                ...
                <li class="list-group-item"><strong>Số lượt sử dụng tối đa:</strong> {{ $voucher->max_usage ?? '-' }}</li>
